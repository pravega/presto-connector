...
public class StreamCutRangeIterator
        implements Iterator<DecodableEvent>
{
    ...
    public StreamCutRangeIterator(PravegaSegmentManager segmentManager, StreamCutRangeReaderArgs streamCutRangeReaderArgs)
    {
        this.segmentManager = segmentManager;

        this.streamCutRange = streamCutRangeReaderArgs.getStreamCutRange();

        log.info("open iterator for " + streamCutRange);
        this.segmentIterator =
                segmentManager.getSegments(streamCutRangeReaderArgs.getScope(),
                        streamCutRangeReaderArgs.getStream(),
                        streamCutRangeReaderArgs.getStreamCutRange().getStart(),
                        streamCutRangeReaderArgs.getStreamCutRange().getEnd()).getIterator();
    }
