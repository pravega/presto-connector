...
/**
 * Json description to parse a single field from a Pravega stream message. See {@link io.pravega.connectors.presto.PravegaStreamDescription} for more details.
 */
