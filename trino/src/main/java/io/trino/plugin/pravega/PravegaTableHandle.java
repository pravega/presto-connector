        ...
        implements ConnectorTableHandle
{
    ...
    @JsonCreator
    public PravegaTableHandle(@JsonProperty("schemaName") String schemaName,
    ...
    public int hashCode()
    {
        return Objects.hash(schemaName, tableName, objectName, objectType, schema, schemaRegistryGroupId);
    }
